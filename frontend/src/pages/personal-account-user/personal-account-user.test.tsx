...
describe('Component: AccountUserPage', () => {
  it('should render correctly', () => {
    ...
    const trainingLink: HTMLAnchorElement = screen.getByTestId('orders');
    expect(trainingLink.href).toContain(`${AppRoute.AccountUser}/orders`);

    const friendLink: HTMLAnchorElement = screen.getByTestId('friends');
    expect(friendLink.href).toContain(`${AppRoute.AccountUser}/friends`);
